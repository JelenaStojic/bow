...
// Bows iz leve navigacije, potom kliknuti na luk koji se zove Samick Sage, i onda proveriti da ime tog luka na njegovoj stranici zaista sadrži reč Samick.
...
public class Domaci {
    public static void main(String[] args) {
        ...
        driverWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"ctl00_MainContent_ListView1_ctrl36_Label3\"]")));
        WebElement samickSage = driver.findElement(By.xpath("//*[@id=\"ctl00_MainContent_ListView1_ctrl36_Panel1\"]/figure/a/img"));
        samickSage.click();
        ...
        if(element.getText().contains("Samick")){
            System.out.println("Ime luka na njegovoj stranici sadrzi Samick");
        }
        driver.close();
    }
}